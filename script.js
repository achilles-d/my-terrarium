...
function dragElement(terrariumElement) {
	...
	terrariumElement.onpointerdown = pointerDrag; // Now using pointer API
	...
	function pointerDrag(e) {
		...
		document.onpointermove = elementDrag; // call next function when pointer moves
		//5. when the mouse is lifted, stop the drag
		document.onpointerup = closeDragElement; // close it when pointer moves up
	}
